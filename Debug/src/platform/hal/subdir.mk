...
C_SRCS += \
../src/platform/hal/platform_hal.c 

OBJS += \
./src/platform/hal/platform_hal.o 

C_DEPS += \
./src/platform/hal/platform_hal.d 


# Each subdirectory must supply rules for building sources it contributes
src/platform/hal/%.o src/platform/hal/%.su src/platform/hal/%.cyclo: ../src/platform/hal/%.c src/platform/hal/subdir.mk
...
clean: clean-src-2f-platform-2f-hal

clean-src-2f-platform-2f-hal:
	-$(RM) ./src/platform/hal/platform_hal.cyclo ./src/platform/hal/platform_hal.d ./src/platform/hal/platform_hal.o ./src/platform/hal/platform_hal.su

.PHONY: clean-src-2f-platform-2f-hal
